...
import (
	"fmt"
	acctest1 "terraform-provider-sneller/sneller/acctest"
	"testing"
...
func TestAccDataSourceUser(t *testing.T) {
	...
	baseConfig := acctest1.ProviderConfig + `
	...
	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: acctest1.TestAccProtoV6ProviderFactories,
